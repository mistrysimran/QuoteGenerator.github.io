...
document.querySelector("#generate3").addEventListener("click", () => {
   generate3();
});
...
function generate2()
{
    ...
    document.querySelector("#quote2").textContent = quote;
    document.querySelector("#author2").textContent = author;
...
function generate3()
{
    ...
    document.querySelector("#quote3").textContent = quote;
    document.querySelector("#author3").textContent = author;
